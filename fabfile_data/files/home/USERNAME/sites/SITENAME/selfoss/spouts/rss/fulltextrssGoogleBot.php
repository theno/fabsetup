 ...
 * @author     Theodor Nolte (google-bot user-agent mod only)
 */
class fulltextrssGoogleBot extends feed {
     ...
     * @var string
     */
    public $name = 'RSS Feed (with FullTextRss) user-agent Google Bot';
     ...
     * @var string
     */
    public $description = 'This feed extracts full text article from webpages as google bot with an embedded version of Full-Text RSS';
